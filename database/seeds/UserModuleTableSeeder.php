...
class UserModuleTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('user_module')->insert(array(
            array('user_id' => 4, 'module_id' => 1, 'assigned_by' => 1, 'grade' => 80, 'assigned' => '2019-02-10', 'due' => '2019-02-17', 'completed' => '2019-02-16', 'report_link' => '#'),
            array('user_id' => 4, 'module_id' => 2, 'assigned_by' => 1, 'grade' => 87, 'assigned' => '2019-02-05', 'due' => '2019-02-12', 'completed' => '2019-02-12', 'report_link' => '#'),
